...
def get_feature_catalog() -> List[FeatureSpec]:
    return [
        # ── COLOR ───────────────────────────────────────────────────────────────
        FeatureSpec('hsv_hist',     'HSV Histogram',           'color',   'Histogram màu HSV 16x6x3 = 288 bins.',       'cosine', True,  '288', is_histogram=True, supports_chi_square=True),
        ...
        FeatureSpec('hue_hist',     'Hue Histogram',           'color',   'Histogram riêng kênh Hue.',                  'cosine', False, '36',  is_histogram=True, supports_chi_square=True),
        ...
        FeatureSpec('color_moments','Color Moments',           'color',   'Mean, std, skew trên từng kênh RGB foreground.', 'l2',   True,  '9'),
        FeatureSpec('lab_moments',  'Lab Moments',             'color',   'Mean/std trên Lab foreground.',               'l2',     False, '6'),
        # ── SHAPE ───────────────────────────────────────────────────────────────
        FeatureSpec('hu_moments',   'Hu Moments',              'shape',   '7 Hu moments trên mask nhị phân, sau log transform.', 'l2', True, '7'),
        FeatureSpec('geometric_shape','Geometric Shape',       'shape',   'Thuộc tính hình học cơ bản của vùng hoa.',   'l2',     True,  '13'),
        ...
        FeatureSpec('fourier_shape','Fourier Shape Descriptor','shape',   'Magnitude FFT của contour đã resample/center/normalize.', 'cosine', False, '32'),
        FeatureSpec('symmetry_score','Symmetry Score',         'shape',   'Độ đối xứng theo overlap foreground với ảnh lật.', 'l2', False, '2'),
        # ── TEXTURE / GRADIENT ──────────────────────────────────────────────────
        FeatureSpec('lbp',          'LBP Histogram',           'texture', 'LBP uniform P=24, R=3 trên foreground.',      'cosine', True,  '26', is_histogram=True, supports_chi_square=True),
        FeatureSpec('glcm',         'GLCM Features',           'texture', 'Contrast, homogeneity, energy... từ GLCM foreground.', 'l2', False, '6'),
        ...
        # ── EDGE ────────────────────────────────────────────────────────────────
        FeatureSpec('edge_orientation_hist','Edge Orientation Histogram','edge','Histogram hướng tại pixel Canny edge.','cosine',True,'36', is_histogram=True, supports_chi_square=True),
